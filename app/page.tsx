        ...
        >
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              ...
              <Link
                href="/editor"
                className="group flex items-center gap-2 bg-white text-gray-700 border border-gray-200 px-6 py-3 rounded-lg text-sm font-semibold hover:bg-gray-50 hover:border-gray-300 transition-all"
              >
                <Pencil size={16} />
                Edit PDF
              </Link>
